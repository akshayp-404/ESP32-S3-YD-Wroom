/*
This code shows how the ESP32-S3-YD-Wroom board can input keystrokes from a USB keyboard using it's USB Host female ports
...
On the ESP32-S3-YD-Wroom board Use the USB Type-C (COM) port for uploading the code or for the serial monitor. And USB/OTG Port for connecting Wired Keyboard.
